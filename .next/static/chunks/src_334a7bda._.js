...
function LoginPage() {
    ...
    const onSignUpSubmit = (data)=>{
        const existingProfile = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$profile$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getProfileByEmail"])(data.email);
        if (existingProfile) {
            toast({
                variant: "destructive",
        ...
        const newProfile = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$profile$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createProfile"])({
            name: data.name,
            email: data.email,
            password: data.password
        });
...
//# sourceMappingURL=src_334a7bda._.js.map